...
public class Flight {
    ...
    public LocalDateTime arrivalDateTime() {
        return getSegments().getLast().getArrivalDate();
    }

    public long flightDurationInMinutes() {
        return ChronoUnit.MINUTES.between(departureDateTime(), arrivalDateTime());
    }

    public long flightDurationInHours() {
        return ChronoUnit.HOURS.between(departureDateTime(), arrivalDateTime());
    }
